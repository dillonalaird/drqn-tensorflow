...
recurrent model with linear attention. DRQN-g is the recurrent model with
global attention and DRQN2-g is the same as DRQN-g except with a $2$ layer LSTM.\\
\\
...
but struggled to gain momentum on average reward per life. Interestingly, when we
added another layer, while it had a harder time minimizing the loss, the average
score was much more consistent and seemed to converge.\\
