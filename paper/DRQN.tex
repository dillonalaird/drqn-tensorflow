...
flying RC helicopters [8]. More recently 
...
that assigns a fixed importance over the previous states and a global attention
whose importance assigned to previous states is depenedent on the current state. \\
\\
...
[8] Andrew Y. Ng, H. Jin Kim, Michael I. Jordan and Shankar Sastry. {\it Neural Information Processing Systems}, 2003.
