...
slightly better on the three measures. However, note that the 2-layer RNN has more 
difficulty minimizing loss than the 1-layer RNN after $1.8$ million iterations. \\
\\
