...
\section{Introduction}
    ...
    short term memory (LSTM) [6] and a deep Q-network (DRQN) similar to [5].  We
    wish to demonstrate that introducing recurrent network architecture into the
...
Montezuma's Revenge [0]. To preprocess the images we grayscale and resize them to
$80\times 80$. \\
\\
